...
var require_AssistantStream = __commonJS({
  "node_modules/openai/lib/AssistantStream.js"(exports2) {
    ...
    var AssistantStream = class _AssistantStream extends EventStream_1.EventStream {
      ...
      static createToolAssistantStream(threadId, runId, runs2, params, options) {
        const runner = new _AssistantStream();
        runner._run(() => runner._runToolAssistantStream(threadId, runId, runs2, params, {
          ...options,
      ...
      async _runToolAssistantStream(threadId, runId, runs2, params, options) {
        return await this._createToolAssistantStream(runs2, threadId, runId, params, options);
      }
    };
  ...
  "node_modules/openai/resources/responses/responses.js"(exports2) {
    ...
    var Responses = class extends resource_1.APIResource {
      ...
      retrieve(responseId, query = {}, options) {
        if ((0, core_1.isRequestOptions)(query) && options === void 0) {
  ...
  "node_modules/openai/resources/vector-stores/file-batches.js"(exports2) {
    ...
    var FileBatches = class extends resource_1.APIResource {
      ...
      async poll(vectorStoreId, batchId, options) {
        ...
        while (true) {
          const { data: batch2, response } = await this.retrieve(vectorStoreId, batchId, {
            ...options,
            headers
          }).withResponse();
...
var require_openai = __commonJS({
  "node_modules/openai/index.js"(exports2, module2) {
    ...
    exports2 = module2.exports = OpenAI;
    module2.exports.AzureOpenAI = AzureOpenAI;
    exports2.default = OpenAI;
  }
});
...
var embeddings = require_methods6();
var files = require_methods7();
var fine_tuning = require_methods8();
var images = require_methods9();
var models = require_methods10();
var moderations = require_methods11();
var responses = require_methods12();
var runs = require_methods13();
var threads = require_methods14();
var uploads = require_methods15();
var vectorStoreFileBatches = require_methods16();
var vectorStoreFiles = require_methods17();
var vectorStores = require_methods18();
var OpenaiApi = class {
